pipeline {
  ...
  post {
    ...
    failure {
      emailext(subject: 'Quanthub: Dev Test Results', attachmentsPattern: '**/*.html', body: 'Check console output at $BUILD_URL/console to view the results.', from: 'JENKINS-CI-CD', to: 'achavan@55-ip.com')
    }
